...
GLOBAL_CPPFLAGS += -DLINUX -DOMR_MUSL_CLIB -Wno-stringop-truncation -D_REENTRANT -D_FILE_OFFSET_BITS=64
ifeq (gcc,$(OMR_TOOLCHAIN))
...
ifneq (,$(findstring executable,$(ARTIFACT_TYPE)))
  ...
  ## Default Libraries
  DEFAULT_LIBS:=-lm -lpthread -lc -lrt -ldl -lutil -lunwind -lexecinfo -Wl,-z,origin,-rpath,\$$ORIGIN,--disable-new-dtags,-rpath-link,$(top_srcdir)
